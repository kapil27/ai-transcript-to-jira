...
"""
    ...
    try:
        parser = OllamaTranscriptParser()
        print("Sending transcript to Ollama for processing...")
...
"""
        ...
        # Parse transcript
        parser = OllamaTranscriptParser()
        print("Processing transcript with Ollama...")
        ...
        # Save test output
        with open('test_ollama_output.csv', 'w', encoding='utf-8') as f:
            f.write(csv_content)
        ...
        print(f"   - Saved to 'test_ollama_output.csv'")
